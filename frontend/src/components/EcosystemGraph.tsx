  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-6 right-[260px] z-30 rounded-md bg-[#1A1D27]/95 backdrop-blur border border-[#2A2D3A] px-3 py-1.5 text-xs font-medium text-[#E8E9ED] hover:bg-[#232733] shadow-md"
      >
        Fit to view
      </button>
      <ForceGraph2D
